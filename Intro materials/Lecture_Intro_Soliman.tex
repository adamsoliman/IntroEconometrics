...
\only<1-1>{
	...
	\begin{wideitemize}
		...
		\item Our Teaching Assistant (TA) is Travis and will hold office hours (TBD)
	\end{wideitemize}
...
\begin{minipage}{.5\textwidth}
	\begin{wideitemize}
		...
		\begin{wideitemize}
			\item January 29 (No Class): One Page Proposal for Final Project Due			 
			...
			\item Final Project Presentations: April 9, April 14, April 16, April 21, April 23
