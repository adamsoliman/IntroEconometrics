...
\only<1-1>{
	...
	\begin{wideitemize}
		\item Lectures: Tues/Thurs from PM to PM in Powers Hall 
		\item Lab: Thursday from PM to PM in Powers Hall 
		\item My office hours are Wednesdays from 3PM to 5PM on Zoom
		\item Our Teaching Assistants (TAs) are , and
		\begin{wideitemize}
			\item All TAs will hold OHs. Times/locations for TA OHs will be announced shortly
		\end{wideitemize}
	\end{wideitemize}
	...
	\begin{wideitemize}
		\item We will \textbf{exclusively} use Slack for our interactions. Please do not contact me by email unless there's a legitimate reason to
		\begin{itemize}
			\item I will be checking Slack sparingly so please help one another in the meantime
		\end{itemize}
