...
%\pause 
		\item My research fields are the economics of crime and health economics, and some of my work tries to answer research questions such as:
		\begin{enumerate}
...
%		\begin{itemize} \item I will be checking Slack sparingly so please help one another in the meantime \end{itemize}
		\item The main course materials are posted on \href{https://adamsoliman.github.io/IntroEconometrics/}{the Github course website}, and are regularly updated. Other communication will be via Canvas.
	\end{wideitemize}
...
\begin{frame}{\bf \large Course Roadmap -- The Topics}
