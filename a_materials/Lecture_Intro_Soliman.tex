...
\date{Introduction to Econometrics (ECON 4050) \\ Clemson University}
...
%\pause 
		\item My research fields are the economics of crime and health economics, and some research questions of interest include
		\begin{enumerate}
			\item What are the impacts of cracking down on rogue doctors during the opioid epidemic?
			\item Do police respond to changes in punishment severity?
			\item How do agricultural interventions in source countries affect the global cocaine trade?
		\end{enumerate}
	\end{wideitemize}
\end{frame}

\begin{comment}
\begin{frame}{\bf \large A little bit about your classmates (Standing and Major)}
	
	\begin{figure}[htbp!]
		\centering
		\includegraphics[width=0.46\linewidth]{figs/class_econ4050}\includegraphics[width=0.54\linewidth]{figs/major_econ4050}
	\end{figure}
\end{frame}
...
\begin{comment}
	...
	\begin{wideitemize}
		\item Lectures: 4050-002 TR from 12:30PM to 1:15PM, Powers Hall G016
		\item Labs: 4051-001 Tuesday 5:30PM to 8:30PM (Caleb) or ECON 4051-002 Wednesday 5:30PM--8:30PM (Haoran)
		...
		\item TA office hours: Caleb will hold them Tuesdays from 4-5pm in Powers 318G and Haoran on Fridays from 12-1pm in Powers 314B. 
	\end{wideitemize}
\end{comment}

\begin{frame}{\bf \large Logistics}
\begin{wideenumerate}
	\item Content: %and communication:
...
%		\begin{itemize} \item I will be checking Slack sparingly so please help one another in the meantime \end{itemize}
		\item The main course materials are currently posted on \href{https://adamsoliman.github.io/IntroEconometrics/}{the Github course website}. Other communication will be via Canvas.
	\end{wideitemize}
...
\item Assessments:
\begin{wideitemize}
	\item Lab Assignments						12.5\%
	\item In-Class Assessments					12.5\%
	\item Coding Midterm (In Class)				20\%
	\item Theory Midterm (In Class)				20\%
...
\begin{frame}[label=splitprob]{\bf \large What is the causal effect on your earnings of going to Clemson instead of USC? \\ {\normalsize How to answer this? Potential paths forward}}
\begin{wideenumerate}
...
\hyperlink{framework}{\beamergotobutton{Splitting up the problem/ Framework for thinking about these steps}}	
\end{frame}
...
\begin{minipage}{.5\textwidth}
	\begin{wideitemize}
		...
		\begin{wideitemize}
			\item October 9: One Page Proposal for Final Project Due
			\item October 15: Coding Midterm
			\item November 3: No Class (Election Day)
			\item November 5: Theory Midterm
			\item November 24, 26: No Class (Thanksgiving)
			\item Final Project Presentations: November 10, 12, 17, 19, December 1, 3
			\item Final Project: Due at the scheduled final exam time for this course. There will not be a final exam. 
		\end{wideitemize}
	\end{wideitemize}
\end{minipage}
\end{frame}
...
\begin{frame}[label = framework]{\bf \large Splitting up the problem \hyperlink{splitprob}{\beamergotobutton{Back}}}
	\begin{wideitemize}
...
\begin{frame}{\bf \large Framework for thinking about these steps \hyperlink{splitprob}{\beamergotobutton{Back}}}
