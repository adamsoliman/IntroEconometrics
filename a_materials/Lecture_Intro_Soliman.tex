...
\date{Introduction to Econometrics (ECON 4050) \\ Clemson University \\ Fall 2026}
...
%\pause 
		...
		\begin{enumerate}
			...
			\item What happens to neighborhood crime when investors buy many properties in that area, converting single family homes to rentals?
		\end{enumerate}
	\end{wideitemize}
\end{frame}
...
\only<1-1>{
	...
	\begin{wideitemize}
		...
		\item Labs: 4051-001 Tuesday 5:30PM to 8:30PM or ECON 4051-002 Wednesday 5:30PM--8:30PM, Powers Hall
		...
		\item TA office hours: Caleb holds them Wednesdays from 2pm to 3pm. Contact him in advance if you plan to attend.
	\end{wideitemize}
