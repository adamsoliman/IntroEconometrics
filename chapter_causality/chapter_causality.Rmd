...
Compute the average percentage of girls, african americans, and free lunch qualifiers by grade *and* treatment class. (*Hint*: The following computes the percentage of girls: `share_female = mean(gender == "female") * 100` along with `mutate()`, but in this circumstance, you need to use `group_by()`, `%>%` and `summarise()`, as we did in the regression lectures with `grades`.
...
star_df = readr::read_csv(file = "https://www.dropbox.com/scl/fi/l7fz6p09uwbelg8ks15pl/star_data.csv?rlkey=y3g3l55fsyhvtypldp0ugpmnm&dl=1")
