...
toy_data <- read.csv("../../data_for_tasks/toy_data_2.csv")
...
1\. Load the *STAR* data from [here](https://github.com/adamsoliman/IntroEconometrics/blob/master/data_for_tasks/star_data.csv) and assign it to an object called `star_df`.

```{r}
# remember to change the path
star_df <- read.csv("~/Documents/GitHub/Econometrics-Slides/data_for_tasks/star_data.csv")
```
