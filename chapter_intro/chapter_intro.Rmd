...
### Moving forward, you will be using R in every class with various tasks (i.e., implementing things you are learning in real time), so always bring your laptop (and you should have already installed R and RStudio using instructions from [this link](https://rstudio-education.github.io/hopr/starting.html) from the Canvas message...)
...
# `data.frame`: useful functions to describe one
```{r}
