...
1. Load the *STAR* data from [here](https://github.com/adamsoliman/IntroEconometrics/blob/master/data%20for%20tasks/grade5_isl.csv), using `read.csv`, and assign it to an object called `star_df`. Keep only cases with no `NA`s with the following code:  
