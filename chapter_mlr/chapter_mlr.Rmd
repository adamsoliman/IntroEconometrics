...
**NOTE:** When we say “suppose we omit work experience,” we are implicitly holding the rest of the model fixed and asking about the bias attributable to that particular omission. If both ability and experience are omitted, then both contribute to the bias, and the overall bias is ambiguous, as the upward bias from omitted ability and the downward bias from omitted experience may partially offset each other. Which effect dominates is an empirical question.
