...
Let's analyse the regression results using **reading** score as the dependent variable. Load the data from [here](https://github.com/adamsoliman/IntroEconometrics/blob/master/data%20for%20tasks/grade5_isl.csv) as `grades`.
