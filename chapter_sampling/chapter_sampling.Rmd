...
```{r, echo = TRUE}
bowl <- read.csv("~/Documents/GitHub/Econometrics-Slides/data for tasks/pasta.csv")
...
1. Load the [data](https://www.dropbox.com/s/qpjsk0rfgc0gx80/pasta.csv?dl=1) into an object `pasta`. Careful with the names of objects.
