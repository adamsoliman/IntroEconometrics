...
1. Create a data.frame containing the proportions of green pasta from the previous slide. Name the object `pasta` and name the variable containing the proportions `prop_green`. (Hint: to create a data.frame you need to use the `data.frame()` function.)
The proportions are as follows: `(0.7,0.7,0.5,0.5,0.3,0.5,0.4,0.45,0.55,0.4,0.35,0.45,0.45,0.7,0.55,0.5,0.35,0.65)`

```{r}
# don't forget to use comments as needed
pastasample <- data.frame(prop_green = c(0.7,0.7,0.5,0.5,0.3,0.5,0.4,0.45,0.55,0.4,
                                   0.35,0.45,0.45,0.7,0.55,0.5,0.35,0.65))
```
