...
```{r}
pastasample <- data.frame(prop_green = c(0.7,0.7,0.5,0.5,0.3,0.5,0.4,0.45,0.55,0.4,0.35,0.45,0.45,0.7,0.55,0.5,0.35,0.65))
```
...
```{r}
library(tidyverse)
ggplot(pastasample, aes(x = prop_green)) +
...
2\. Load the [data]("https://www.dropbox.com/scl/fi/m6f187nd2aiwoqzckcpa0/pasta.csv?rlkey=ohaqb5iepispqtoh2dmcpoxpr&dl=1") into an object `pasta`.

```{r}
# your path will look different
pasta <- read.csv("/Users/adamsoliman/Library/CloudStorage/Dropbox/Clemson/Econometrics Course/data for tasks/pasta.csv")
```
