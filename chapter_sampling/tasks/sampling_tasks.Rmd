...
2. Load the [data](https://github.com/adamsoliman/IntroEconometrics/blob/master/data_for_tasks/pasta.csv) into an object `pasta`.

```{r}
pasta <- read.csv("~/Documents/GitHub/Econometrics-Slides/data_for_tasks/pasta.csv")
```
