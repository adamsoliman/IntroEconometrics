...
ligue1_18_19 <- read.csv("/Users/adamsoliman/Documents/GitHub/Econometrics-Slides/Final project information/Data/Ligue1_18_19.csv", encoding="UTF-8") %>%
    select(Wk, Day, Date, Time, Home, Score,
           Away, Attendance, Venue, Referee) %>% 
    mutate(Season="2018-2019")

ligue1_17_18 <- read.csv("/Users/adamsoliman/Documents/GitHub/Econometrics-Slides/Final project information/Data/Ligue1_17_18.csv", encoding="UTF-8") %>% 
    select(Wk, Day, Date, Time, Home, Score,
           Away, Attendance, Venue, Referee) %>% 
    mutate(Season="2017-2018")

ligue1_16_17 <- read.csv("/Users/adamsoliman/Documents/GitHub/Econometrics-Slides/Final project information/Data/Ligue1_16_17.csv", encoding="UTF-8") %>% 
    select(Wk, Day, Date, Time, Home, Score,
           Away, Attendance, Venue, Referee) %>% 
    mutate(Season="2016-2017")

ligue1_15_16 <- read.csv("/Users/adamsoliman/Documents/GitHub/Econometrics-Slides/Final project information/Data/Ligue1_15_16.csv", encoding="UTF-8") %>% 
    select(Wk, Day, Date, Time, Home, Score,
           Away, Attendance, Venue, Referee) %>%
    mutate(Season="2015-2016")

ligue1_14_15 <- read.csv("/Users/adamsoliman/Documents/GitHub/Econometrics-Slides/Final project information/Data/Ligue1_14_15.csv", encoding="UTF-8") %>%
    select(Wk, Day, Date, Time, Home, Score,
           Away, Attendance, Venue, Referee) %>% 
...
#read budget data
budgets <- read_excel("/Users/adamsoliman/Documents/GitHub/Econometrics-Slides/Final project information/Data/budgets_ligue1.xlsx") %>% 
...
```{r, fig.show="hold", out.width="50%", fig.align="center"}
ligue1_18_19_results <- read.csv("/Users/adamsoliman/Documents/GitHub/Econometrics-Slides/Final project information/Data/Ligue1_results_18_19.csv", encoding="UTF-8") %>%
    select(Rk, Squad) %>% 
    mutate(Season="2018-2019")

ligue1_17_18_results <- read.csv("/Users/adamsoliman/Documents/GitHub/Econometrics-Slides/Final project information/Data/Ligue1_results_17_18.csv", encoding="UTF-8") %>%
    select(Rk, Squad) %>% 
    mutate(Season="2017-2018")

ligue1_16_17_results <- read.csv("/Users/adamsoliman/Documents/GitHub/Econometrics-Slides/Final project information/Data/Ligue1_results_16_17.csv", encoding="UTF-8") %>% 
    select(Rk, Squad) %>% 
    mutate(Season="2016-2017")

ligue1_15_16_results <- read.csv("/Users/adamsoliman/Documents/GitHub/Econometrics-Slides/Final project information/Data/Ligue1_results_15_16.csv", encoding="UTF-8") %>% 
    select(Rk, Squad) %>% 
    mutate(Season="2015-2016")

ligue1_14_15_results <- read.csv("/Users/adamsoliman/Documents/GitHub/Econometrics-Slides/Final project information/Data/Ligue1_results_14_15.csv", encoding="UTF-8") %>%
    select(Rk, Squad) %>% 
    mutate(Season="2014-2015")
